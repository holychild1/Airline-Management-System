...
','Dep.Time','Arr.Time','Aisle/Window','Ec/Biz.')
    ...
    for i in a:
        if i[1]==cntry:
            cntin=i
    cdtf=cdt.split('/')
    pth='C:/Users/Parneet Kaur/OneDrive/Desktop/Projects/Airline management/Months/'+str(cdtf[0])+'/'+str(cdtf[1])+'.txt'
    myfile=open(pth,'rb')
    masterl=[]
    rfv=clnop[cntry]
...
','Dep.Time','Arr.Time','Aisle/Window','Ec/Biz.')
        ...
        Datef=Datef.split('/')
        pth='C:/Users/Parneet Kaur/OneDrive/Desktop/Projects/Airline management/Months/'+str(Datef[0])+'/'+str(Datef[1])+'.txt'
        myfile=open(pth,'rb')
...
def logcheck():
    try:
        ...
        pd=pwd.get()
        logframe.destroy()
        myfile=open('C:/Users/Parneet Kaur/OneDrive/Desktop/Projects/Airline management/Python password module/Private/linfo.dat','rb')
        data=load(myfile)
        myfile.close()
        x=0
        for i in data:
...
def data_entry():
    ...
    ino=clno[tget]
    date1=date.split('/')
    pth='C:/Users/Parneet Kaur/OneDrive/Desktop/Projects/Airline management/Months/'+str(date1[0])+'/'+str(date1[1])+'.txt'
    myfile=open(pth,'rb')
    pth2='C:/Users/Parneet Kaur/OneDrive/Desktop/Projects/Airline management/Months/'+str(date1[0])+'/test.txt'
